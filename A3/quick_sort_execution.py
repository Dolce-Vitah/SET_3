...
y_file_path_first = 'Y_quick_sort_random.txt'
y_file_path_second = 'Y_quick_sort_reversed.txt'
y_file_path_third = 'Y_quick_sort_nearly_sorted.txt'
...
plt.title('Время выполнения алгоритма Quick Sort', fontsize=14)
