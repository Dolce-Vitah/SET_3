...
y_file_path_first = 'Y_hybrid_random.txt'
y_file_path_second = 'Y_hybrid_reversed.txt'
y_file_path_third = 'Y_hybrid_nearly_sorted.txt'
...
plt.title('Время выполнения алгоритма Merge + Insertion Sort', fontsize=14)
