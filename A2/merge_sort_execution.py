...
y_file_path_first = 'Y_merge_random.txt'
y_file_path_second = 'Y_merge_reversed.txt'
y_file_path_third = 'Y_merge_nearly_sorted.txt'
...
plt.title('Время выполнения алгоритма Merge Sort', fontsize=14)
